...
Created: 3/15/2017
Modified: 3/15/2017
Notes: Basic console application to run the code.
*/


using System;
using KataYahtzee.BLL;
...
namespace KataYahtzee
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to KataYahtzee press anykey to continue");
            GameLogic.PrintDiceValues();
            Console.ReadKey();
